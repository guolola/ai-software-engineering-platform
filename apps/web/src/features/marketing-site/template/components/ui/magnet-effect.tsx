...
import { Slot, type WithAsChild } from '@/features/marketing-site/template/components/ui/wrapper'
...
const Magnetic = React.forwardRef(function Magnetic({
  strength = 0.5,
  range = 120,
  ...
  asChild = false,
  ...props
}: MagneticProps, ref: React.ForwardedRef<any>) {
