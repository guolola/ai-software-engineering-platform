// Owns the AdminCN color preset token maps used by the workspace theme picker.
...
export const themePresets = {
  // Restores the former workbench palette while keeping dark primary controls at AA contrast.
  'classic-indigo': {
    ...
    styles: {
      light: {
        ...
        secondary: '#eff4ff',
        'secondary-foreground': '#0b1c30',
        muted: '#eff4ff',
        'muted-foreground': '#5b5e69',
        accent: '#e5eeff',
        'accent-foreground': '#0b1c30',
        border: '#dce9ff',
        input: '#dce9ff',
        'input-background': '#eff4ff',
        ring: '#4441c4',
        'chart-1': '#2f6feb',
        'chart-2': '#1a7f37',
        'chart-3': '#bf8700',
      ...
      dark: {
        ...
        'sidebar-primary-foreground': '#0b1c30',
        'sidebar-accent': '#1c2128',
        'sidebar-accent-foreground': '#f0f2f5',
